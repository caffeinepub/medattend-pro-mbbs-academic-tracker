// Grouped UI card for consecutive class periods with duration display
...
export default function ConsecutiveClassGroupCard({
  ...
  // Calculate total duration for grouped classes
  const totalDuration = group.entries.reduce((sum, { entry }) => sum + (entry.duration || 60), 0);
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>
            ...
            <span className="text-xs ml-2">({totalDuration} min)</span>
          </span>
        </div>
